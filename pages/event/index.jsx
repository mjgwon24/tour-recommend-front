    ...
    return (
        <div className="flex flex-col items-center bg-gradient-to-b from-[#FFA50088] from-0% to-[#FF4D0188] to-100% bg-[#FFA500] pt-[106.4px] pb-[35px] px-[40px] min-w-[1280px] min-h-screen">
            ...
            <div className="flex flex-col w-[1200px] rounded-[14.63px] bg-[#FFB020] pt-[10px] pr-[23.27px] pl-[22.61px] pb-[27px]">
                ...
                <div className="flex gap-[74.48px]">
                    <div className="flex flex-col w-[232.75px] h-[127.68px]">
                        <div className="relative bottom-[0%] z-20 w-[232.75px] h-[127.68px] rounded-[14.63px] bg-[#FFF]/40">
                            <div className="flex flex-col justify-center">
                                <div className="flex justify-center text-[26.6px] font-semibold w-[232.75px] h-[127.68px]">
                                    <div className="flex flex-col justify-center">
                                        여행지A
                                    </div>
                                </div>
                        ...
                        className="relative bottom-[100%] rounded-[14.63px] w-[232.75px] h-[127.68px] bg-[#F1F1F1] px-[5px] py-[5px] resize-none"/>
                    </div>
                    <div className="flex flex-col w-[232.75px] h-[127.68px]">
                        <div className="relative bottom-[0%] z-20 w-[232.75px] h-[127.68px] rounded-[14.63px] bg-[#FFF]/40">
                            <div className="flex flex-col justify-center">
