            ...
            <div className="rounded-t-[21.28px] flex flex-col items-center w-screen min-h-screen pt-[40.63px] bg-white">
                <div className="flex flex-col gap-7">
                    <div className="flex flex-col">
                        ...
                        <input type="text" className="rounded-[14.63px] w-[537.98px] h-[48.545px] bg-[#F1F1F1] px-[19.28px]" placeholder="제목을 입력해주세요"></input>
                    </div>
                    <div className="flex flex-col">
                        <label className="text-[23.94px] weight-700 pb-1">유형</label>
                        <div className="flex gap-[18.62px]">
                            <button className="w-[75.81px] h-[33.25px] rounded-[7.98px] border-solid border-[1.33px] border-[#6C6C6C] hover:bg-[#FFEECE] hover:text-[#F18304] hover:border-[#F18304]">식당</button>
                            <button className="w-[75.81px] h-[33.25px] rounded-[7.98px] border-solid border-[1.33px] border-[#6C6C6C] hover:bg-[#FFEECE] hover:text-[#F18304] hover:border-[#F18304]">숙박</button>
                            <button className="w-[75.81px] h-[33.25px] rounded-[7.98px] border-solid border-[1.33px] border-[#6C6C6C] hover:bg-[#FFEECE] hover:text-[#F18304] hover:border-[#F18304]">전시</button>
                        </div>
                    </div>
                    <div className="flex flex-col">
                        <label className="text-[23.94px] weight-700 pb-1">내용</label>
                    ...
                    <div className="flex flex-col">
                        ...
                        <div className="flex gap-[9px]">
                            ...
                            <div className="flex items-center gap-[1px] pl-[5px] pr-[2px] py-[5px] rounded-[10px] border-[1px] border-solid border-[#bdbdbd] ">
                                <div className="cursor-pointer text-[14px]">음식 사진1.jpg</div>
                                <TiDelete className="w-[22px] h-[22px] cursor-pointer text-[gray]"></TiDelete>
                            </div>
                            <div className="flex items-center gap-[1px] pl-[5px] pr-[2px] py-[5px] rounded-[10px] border-[1px] border-solid border-[#bdbdbd] ">
                                <div className="cursor-pointer text-[14px]">음식 사진2.jpg</div>
                                <TiDelete className="w-[22px] h-[22px] cursor-pointer text-[gray]"></TiDelete>
                            </div>
                            <div className="flex items-center gap-[1px] pl-[5px] pr-[2px] py-[5px] rounded-[10px] border-[1px] border-solid border-[#bdbdbd] ">
                                <div className="cursor-pointer text-[14px]">음식 사진3.jpg</div>
                                <TiDelete className="w-[22px] h-[22px] cursor-pointer text-[gray]"></TiDelete>
                            </div>
                        </div>
                    </div>
